...
abstract class AbstractTaskTests : AbstractFileTests() {
    ...
    protected fun mergeArrays(mergeArrays: (Array<Int>, Array<Int?>) -> Unit) {
        ...
        val result2 = arrayOf(null, null, null, null, 10, 13, 19, 123, 188, 423)
        mergeArrays(arrayOf(29, 315, 420, 923), result2)
        assertArrayEquals(arrayOf(10, 13, 19, 29, 123, 188, 315, 420, 423, 923), result2)
